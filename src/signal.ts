import { IBrain, IData } from "./types";
 ...
 */
export function distanceFromSignalStrength(signalRadius: number, signalStrength: number): number {
    if (signalStrength <= 0 || signalStrength >= 1) return 0;
 ...
 */
export function ignoreFloorsBySignal(brain: IBrain, data: IData): void {
